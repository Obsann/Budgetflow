    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="dashboard.php" class="hover:text-blue-400 transition">Dashboard</a></li>
                    <li><a href="view_all.php" class="hover:text-blue-400 transition">Transactions</a></li>
                    <li><a href="report.php" class="hover:text-blue-400 transition">Reports</a></li>
                    <li><a href="create.php" class="hover:text-blue-400 transition">Add Record</a></li>
                </ul>
            </div>
            <!-- Legal / Connect -->
            <div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 text-sm">
                &copy; <?php echo date('Y'); ?> BudgetFlow. All rights reserved.
            </p>
