...
// Injects a consistent footer into all pages, matching the GitHub footer.php structure

function loadFooter() {
    const currentYear = new Date().getFullYear();

    const footerHtml = `
<footer class="mt-auto border-t border-gray-800 bg-slate-900/50 backdrop-blur-md">
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <!-- Brand -->
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center space-x-2 mb-4">
                    <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm">BF</div>
                    <span class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">BudgetFlow</span>
                </div>
                <p class="text-gray-400 text-sm leading-relaxed max-w-xs">
                    Empowering students to take control of their finances with smart tracking, visual analytics, and intuitive budgeting tools.
                </p>
            </div>
            <!-- Quick Links -->
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="index.html" class="hover:text-blue-400 transition">Dashboard</a></li>
                    <li><a href="view_all.html" class="hover:text-blue-400 transition">Transactions</a></li>
                    <li><a href="report.html" class="hover:text-blue-400 transition">Reports</a></li>
                    <li><a href="create.html" class="hover:text-blue-400 transition">Add Record</a></li>
                </ul>
            </div>
            <!-- Legal / Connect -->
            <div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 text-sm">
                &copy; ${currentYear} BudgetFlow. All rights reserved.
            </p>
